...
internal abstract partial class CDFunctions
{
    ...
    public unsafe static bool IsEnabled(uint actionID) => ActionManager.Instance()->GetActionStatus(FFXIVClientStructs.FFXIV.Client.Game.ActionType.Action, actionID) == 0;
}
